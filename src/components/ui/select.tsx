...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'whitespace-nowrap rounded-xl border border-slate-200 bg-white',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'rounded-lg py-2 pl-3 pr-9 text-sm font-medium text-slate-700',
      'outline-none',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('px-3 py-1.5 text-[10px] font-black text-slate-400 uppercase tracking-wider', className)}
    {...props}
  />
))
